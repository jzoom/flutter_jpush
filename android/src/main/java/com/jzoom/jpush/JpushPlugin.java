...
public class JpushPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        JpushPlugin.channel = channel;
        Log.d(TAG,"register jpush plugin");
        JpushPlugin.activity = registrar.activity();
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        if ("initPush".equals(method)) {
            ...
            this.crashLogON();
            result.success(true);
        } else if ("notifyJSDidLoad".equals(method)) {
            this.notifyJSDidLoad(result);
    ...
    public void notifyJSDidLoad(Result result) {
        // send cached event
        mRAC = getCurrentActivity();
        sendEvent();
        result.success(0);
    }
        ...
        if (mEvent != null) {
            ...
            switch (mEvent) {
                ...
                case RECEIVE_REGISTRATION_ID:
                    ...
                    channel.invokeMethod("", (String) mCachedBundle.get(JPushInterface.EXTRA_REGISTRATION_ID));
                    break;
                ...
                case CONNECTION_CHANGE:
                    if (mCachedBundle != null) {
                        channel.invokeMethod("", mCachedBundle.getBoolean(JPushInterface.EXTRA_CONNECTION_CHANGE, false));
                    }
                    break;
            }
            mEvent = null;
